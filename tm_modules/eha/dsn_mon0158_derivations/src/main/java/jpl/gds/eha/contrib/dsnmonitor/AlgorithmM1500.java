...
/**
 * AlgorithmM1500 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM1500 extends AbstractAlgorithmMHHMMSSFromPoly
{
    /**
     * Perform derivation.
     *
    ...
    {
        final IChannelValue parentM1500 = parentChannelValues.get("M-1500");

        if (parentM1500 == null)
        {
            throw new DerivationException("Missing parent M-1500");
        }
        
        return deriveMHHMMSSChannelFromPoly(parentM1500.intValue(), "M-3614");
    }
