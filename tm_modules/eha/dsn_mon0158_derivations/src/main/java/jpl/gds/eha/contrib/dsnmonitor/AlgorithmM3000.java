...
/**
 * AlgorithmM3000 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM3000 extends AbstractAlgorithmMHHMMSSFromPoly
{
    /**
     * Perform derivation
     *
    ...
    {
        final IChannelValue parentM3000 = parentChannelValues.get("M-3000");

        if (parentM3000 == null)
        {
            throw new DerivationException("Missing parent M-3000");
        }
        
        return deriveMHHMMSSChannelFromPoly(parentM3000.intValue(), "M-3617");
    }
