...
/**
 * AlgorithmM3015 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM3015 extends AbstractAlgorithmMHHMMSSFromPoly
{
    /**
     * Perform derivation
     *
    ...
    {
        final IChannelValue parentM3015 = parentChannelValues.get("M-3015");

        if (parentM3015 == null)
        {
            throw new DerivationException("Missing parent M-3015");
        }
        
        return deriveMHHMMSSChannelFromPoly(parentM3015.intValue(), "M-3621");
    }
