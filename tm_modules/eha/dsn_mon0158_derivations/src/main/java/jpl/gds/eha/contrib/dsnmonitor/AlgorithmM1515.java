...
/**
 * AlgorithmM1515 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM1515 extends AbstractAlgorithmMHHMMSSFromPoly
{
    /**
     * Perform derivation.
     *
    ...
    {
        final IChannelValue parentM1515 = parentChannelValues.get("M-1515");

        if (parentM1515 == null)
        {
            throw new DerivationException("Missing parent M-1515");
        }
        
        return deriveMHHMMSSChannelFromPoly(parentM1515.intValue(), "M-3618");
    }
