...
/**
 * AlgorithmM1074 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM1074 extends AbstractAlgorithmMHHMMSSFromSecs
{
    /**
     * Perform derivation.
     *
    ...
    {
        final IChannelValue parentM1074 = parentChannelValues.get("M-1074");

        if (parentM1074 == null)
        {
            throw new DerivationException("Missing parent M-1074");
        }
        
        return deriveMHHMMSSChannelFromSecs(parentM1074.intValue(), "M-3613");
    }
