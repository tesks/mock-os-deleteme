...
/**
 * AlgorithmM2500 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM2500 extends AbstractAlgorithmMHHMMSSFromPoly
{
    /**
     * Perform derivation
     *
    ...
    {
        final IChannelValue parentM2500 = parentChannelValues.get("M-2500");

        if (parentM2500 == null)
        {
            throw new DerivationException("Missing parent M-2500");
        }
        
        return deriveMHHMMSSChannelFromPoly(parentM2500.intValue(), "M-3616");
    }
