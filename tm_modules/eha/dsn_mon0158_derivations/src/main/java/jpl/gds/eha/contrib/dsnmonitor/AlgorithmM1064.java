...
/**
 * AlgorithmM1064 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM1064 extends AbstractAlgorithmMHHMMSSFromSecs
{
    /**
     * Perform derivation.
     *
    ...
    {
        final IChannelValue parentM1064 = parentChannelValues.get("M-1064");

        if (parentM1064 == null)
        {
            throw new DerivationException("Missing parent M-1064");
        }
        
        return deriveMHHMMSSChannelFromSecs(parentM1064.intValue(), "M-3612");
    }
