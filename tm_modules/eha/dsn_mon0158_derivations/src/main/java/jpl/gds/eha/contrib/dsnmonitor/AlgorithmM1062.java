...
/**
 * AlgorithmM1062 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM1062 extends AbstractAlgorithmMHHMMSSFromSecs
{
    /**
     * Perform derivation.
     *
    ...
    {
        final IChannelValue parentM1062 = parentChannelValues.get("M-1062");

        if (parentM1062 == null)
        {
            throw new DerivationException("Missing parent M-1062");
        }
        
        return deriveMHHMMSSChannelFromSecs(parentM1062.intValue(), "M-3609");
    }
