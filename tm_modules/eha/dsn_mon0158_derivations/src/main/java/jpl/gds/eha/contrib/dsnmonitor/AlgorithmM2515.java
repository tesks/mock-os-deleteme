...
/**
 * AlgorithmM2515 is a M-channel algorithmic derivation from mon158.ccl.
 *
 */
public class AlgorithmM2515 extends AbstractAlgorithmMHHMMSSFromPoly
{
    /**
     * Perform derivation
     *
    ...
    {
        final IChannelValue parentM2515 = parentChannelValues.get("M-2515");

        if (parentM2515 == null)
        {
            throw new DerivationException("Missing parent M-2515");
        }
        
        return deriveMHHMMSSChannelFromPoly(parentM2515.intValue(), "M-3620");
    }
