 ...
 *
 */
public class AlarmValueSet implements IAlarmValueSet
{
	/**
	 ...
	 * 
	 */
	/*package*/ public AlarmValueSet()
	{
		alarmList = new ArrayList<IAlarmValue>(1);
	}

	/*package*/ public AlarmValueSet(Proto3AlarmValueSet set)
	{
		alarmList = new ArrayList<IAlarmValue>(1);
	...
	{
		IAlarmValueSet alarmValueSet = new AlarmValueSet();
    ...
    public IAlarmValueSet copy() {
	    AlarmValueSet result = new AlarmValueSet();
	...
	public void deserialize(Proto3AlarmValueSet alarms) {
		synchronized (this.alarmList) {
			alarms.getAlarmsList().forEach(alarm -> {
				alarmList.add(new AlarmValue(alarm));
			});
		}
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AlarmValueSet other = (AlarmValueSet) obj;
		if (alarmList == null) {
