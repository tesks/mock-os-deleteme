...
/**
 *
 * Run-time class corresponding to an alarm definition object for a low value
 * alarm.
 *
 */
public class LowValueCompareAlarm extends AbstractAlarm {
     ...
     */
	public LowValueCompareAlarm(final IAlarmDefinition def, final TimeComparisonStrategyContextFlag timeStrategy) {
	...
	protected IAlarmValue calculateAlarm(final IAlarmHistoryProvider history, final IServiceChannelValue channelVal)
	{
		...
		if (checkValue <= this.definition.getLowerLimit()) {
