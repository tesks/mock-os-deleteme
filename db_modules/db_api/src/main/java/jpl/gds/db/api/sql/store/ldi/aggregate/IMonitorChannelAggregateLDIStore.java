...
public interface IMonitorChannelAggregateLDIStore extends ILDIStore
{
    /**
     * Store Identification for LDI Inserters
     */
    public static final StoreIdentifier STORE_IDENTIFIER = StoreIdentifier.MonitorChannelAggregate;

    public static final String DB_MONITOR_CHANNEL_AGGREGATE_FIELDS =
        "hostId"          + "," +
        "sessionId"       + "," +
        "sessionFragment" + "," +
        "id"              + "," +
