...
public interface IHeaderChannelAggregateLDIStore extends ILDIStore
{
    /**
     * Store Identification for LDI Inserters
     */
    public static final StoreIdentifier STORE_IDENTIFIER = StoreIdentifier.HeaderChannelAggregate;

    public static final String DB_HEADER_CHANNEL_AGGREGATE_FIELDS =
        "hostId"          + "," +
        "sessionId"       + "," +
        "sessionFragment" + "," +
        "id"              + "," +
