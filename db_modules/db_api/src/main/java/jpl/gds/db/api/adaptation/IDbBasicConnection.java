 ...
 *
 * It does NOT recreate things if they time-out or drop mysteriously. For that
 * you need an IDbExtendedConnection.
 *
 * We do not expect to be called by multiple threads.
 */
public interface IDbBasicConnection extends IDbConnection
{
    /**
