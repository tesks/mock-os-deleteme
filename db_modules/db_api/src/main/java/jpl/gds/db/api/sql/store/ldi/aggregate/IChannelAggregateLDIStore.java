...
public interface IChannelAggregateLDIStore extends ILDIStore
{
    /**
     * Store Identification for LDI Inserters
     */
    public static final StoreIdentifier STORE_IDENTIFIER = StoreIdentifier.ChannelAggregate;

    public static final String DB_CHANNEL_AGGREGATE_FIELDS =
        "hostId"          + "," +
        "sessionId"       + "," +
        "sessionFragment" + "," +
        "id"              + "," +
