...
public interface IChannelAggregateFetch extends IDbSqlFetch  {
    
    public ResultSet getResultSet(IDbSessionInfoProvider tsi, DatabaseTimeRange range, int batchSize, Object... params)
