...
public class SwaggerConfiguration {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("AMPCS CFDP Processor with RESTful Monitor & Control",
                           "The CFDP RESTful API allows runtime monitoring and control of the AMPCS CFDP Processsor (chill_cfdp_processor)",
                           "API TOS",
