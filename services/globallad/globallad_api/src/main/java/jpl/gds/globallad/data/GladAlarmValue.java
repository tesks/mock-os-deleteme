...
/**
 * AlarmValue represents the state of a single alarm on a single channel value.
 */
public class GladAlarmValue implements IAlarmValue
{
     ...
     * @param av
     */
    public GladAlarmValue(Proto3AlarmValue av) {
    	deserialize(av);
    }
     ...
     */
    public GladAlarmValue(final AlarmType type, final AlarmLevel level, final boolean onEu, final boolean inAlarm,
	 ...
	 * 
	 */
    public GladAlarmValue(final IAlarmDefinition alarmDef, final boolean inAlarm, final String state) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GladAlarmValue other = (GladAlarmValue) obj;
		if (alarmId == null) {
