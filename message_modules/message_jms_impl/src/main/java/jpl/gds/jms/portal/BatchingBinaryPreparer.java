 ...
 * into a single message that it pushes to JMS publishers for publication as
 * a binary JMS Bytes message. Handles only a single message type.
 */
public class BatchingBinaryPreparer extends SimpleBinaryPreparer {
    ...
    /**
     * Creates the batching binary preparer.
     ...
     */
    public BatchingBinaryPreparer(final ApplicationContext appContext,
    ...
    /**
     * {@inheritDoc}
     * @see jpl.gds.jms.portal.SimpleBinaryPreparer#enableBatching(boolean)
     */
    @Override
