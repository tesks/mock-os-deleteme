...
# MPCS-8612 Redo for Maven
# MPCS-5070 JM 07/25/13 Major redo
# MPCS-7139 3/26/2015: Removing use of AMPCS_WORKSPACE_SUFFIX
# MPCS-7661 09/29/15 Redo for new build procedures and fix some bugs
...
echo "Destroying and recreating all databases..."
echo

# MPCS-7913 2/16/16
# Moved the PROJECT_FILE (MissionBuildSpec.txt) to mpcstools/devtools
# Removed Ody from PROJECT_FILE. Added m20
