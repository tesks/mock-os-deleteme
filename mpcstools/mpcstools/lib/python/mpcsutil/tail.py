...
Copied from http://code.activestate.com/recipes/436477/
"""
...
class Tail(object):
    ...
    def __init__(self, path, only_new = False,
        ...
        if path is None:
            raise ValueError('Input path was None!')
...
def test():
    [print(line) for line in Tail(os.path.expanduser("~/.bash_profile"))]
