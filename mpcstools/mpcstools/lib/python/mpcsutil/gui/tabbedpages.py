...
(BRN) - This was ripped straight out of the Python 2.6 implementation of IDLE.  The
Tkinter built-in tabbed pages (tk.NoteBook) are hideous.  This is way better.
"""
...
class TabSet(Frame):
    ...
    def _arrange_tabs(self):
        ...
        [_tab.destroy() for _tab in self._tabs.values()]
        self._tabs={}
