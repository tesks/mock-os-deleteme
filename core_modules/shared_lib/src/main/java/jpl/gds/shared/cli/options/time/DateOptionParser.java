...
/**
 * A command line option parsing class for CommandLineOptions whose value is a Date formatted
 * according the AMPCS mission standards.
 * 
 *
 */
public class DateOptionParser extends AbstractOptionParser<IAccurateDateTime> {

    /**
     * Constructor for a date option parser. Always validating.
     */
    public DateOptionParser() {
        super();
        setValidate(true);
    }
