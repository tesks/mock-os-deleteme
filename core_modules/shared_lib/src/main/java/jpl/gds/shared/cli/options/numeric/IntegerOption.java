...
public class IntegerOption extends CommandLineOption<Integer> {
    ...
    /**
     * Constructor for an integer option with restricted range.
     * 
     * @param shortOpt
     ...
     *            for no upper bound
     */
    public IntegerOption(final String shortOpt, final String longOpt,
            final String argName, final String description,
            final boolean required, Integer minValue,
            Integer maxValue) {
        super(shortOpt, longOpt, true, argName, description, required,
                new IntegerOptionParser(minValue, maxValue));
    }

    /**
     * Constructor for an integer option with default range. 
     * 
     * @param shortOpt
     *            short option name; may be null
     * @param longOpt
     ...
     */
    @Override
    public IntegerOptionParser getParser() {
        return (IntegerOptionParser) parser;
    }
