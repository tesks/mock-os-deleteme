...
/**
 * Base class for AMPCS runtime exceptions that can automatically produce a
 * traceback.
 *
 ...
 *
 */
public class AmpcsRuntimeException extends RuntimeException
    implements IAmpcsTracing
{
     ...
     * Constructor.
     */
    protected AmpcsRuntimeException()
    {
        super();
     ...
     */
    protected AmpcsRuntimeException(final String message)
    {
        super(message);
     ...
     */
    protected AmpcsRuntimeException(final Throwable rootCause)
    {
        super(rootCause);
