 ...
 * Unlike IntegerOptionParser, this parser does not require that the valid values
 * be a consecutive range.
 * 
 */
public class DiscreteIntOptionParser extends AbstractOptionParser<Integer> {
	
	private final List<Integer> validValues;
	
	/**
	 * Constructor for a discrete integer option parser with a set of valid values
	 * 
	 * @param validValues
	 *        the list of Integer valid values
	 */
	public DiscreteIntOptionParser(final List <Integer> validValues) {
		super();
		this.validValues = validValues;
	}
	
	/**
	 * Constructor for a discrete integer option parser with all Integer values valid
	 */
	public DiscreteIntOptionParser() {
		super();
		this.validValues = new ArrayList<>();
	}
	
	@Override
	public Integer parse(final ICommandLine commandLine, final ICommandLineOption<Integer> opt) throws ParseException {
