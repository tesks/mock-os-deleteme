...
/**
 * The representation of an SCMF as a notification sent on the message bus.
 * This message is sent out on the bus when an SCMF is successfully transmitted
 * to the FSW.
 * 
 */
public class ScmfMessage extends AbstractUplinkMessage implements
		ICpdUplinkMessage {
	...
	/**
	 * Create a new SCMF message
	 */
	protected ScmfMessage() {
		super(CommandMessageType.Scmf);
	 ...
	 * Create a new SCMF message
	 * 
	 * @param origScmfFile The path to the original SCMF file on disk
	 */
	public ScmfMessage(final String origScmfFile) {
		this();

		this.scmfFile = origScmfFile;
	}
	...
	public void generateStaxXml(final XMLStreamWriter writer)
		...
		try {
			writer.writeStartElement("ScmfMessage"); // <ScmfMessage>
			...
			writer.writeEndElement(); // </ScmfMessage>
		} finally {
	...
	public static class XmlParseHandler extends BaseXmlMessageParseHandler {
		/** The SCMF message being rebuilt from XML */
		private ScmfMessage msg;
		...
		public void startElement(final String uri, final String localName, final String qname,
			...
			if (qname.equalsIgnoreCase(MessageRegistry.getDefaultInternalXmlRoot(CommandMessageType.Scmf))) {
				setInMessage(true);
				this.msg = new ScmfMessage();
		...
		public void endElement(final String uri, final String localName, final String qname)
			...
			if (qname.equals(MessageRegistry.getDefaultInternalXmlRoot(CommandMessageType.Scmf))) {
				addMessage(this.msg);
				setInMessage(false);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see jpl.gds.tc.api.command.IDatabaseArchivableCommand.database.DatabaseArchivable#getDatabaseString()
	 */
	@Override
	public String getDatabaseString() {
		/*
		 * No need to return SCMF file path since it's redundant (SCMF filename
		 * attribute already specifies it).
		 */
		return "";
	}
	...
	public String getOriginalFilename() {
		/*
		 * SCMF filename already specifies the path.
		 */
		return "";
	}
	 ...
	 */
	@Override
	public void setOriginalFilename(final String scmfFilename) {
