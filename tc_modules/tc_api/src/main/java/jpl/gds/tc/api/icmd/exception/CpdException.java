...
/**
 * An exception class use for errors encountered by CPD
 * 
 * @since AMPCS R5
 */
@SuppressWarnings("serial")
public class CpdException extends ICmdException {
	/**
	 * Basic constructor.
	 */
	public CpdException() {
	 ...
	 */
	public CpdException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param message the detailed error message
	 */
	public CpdException(String message) {
		super(message);
	}
	 ...
	 * @param cause the Throwable that triggered this exception
	 */
	public CpdException(Throwable cause) {
		super(cause);
	}
}
