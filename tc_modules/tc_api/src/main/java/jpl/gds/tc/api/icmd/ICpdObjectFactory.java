...
public interface ICpdObjectFactory {
    ...
    public ICpdUplinkStatus createCpdUplinkStatus(final StationMapper stationMap, 
            ...
            final int totalCltus, final IAccurateDateTime bit1RadTime,
            final IAccurateDateTime lastBitRadTime);
    
    public IUplinkMetadata createUplinkMetadata(final long sessionId, final int hostId,
