...
@Configuration
@EnableSwagger2
public class DownlinkSwaggerConfiguration {
    /**
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("AMPCS Downlink with RESTful Monitor & Control",
                           "The Downlink RESTful API allows runtime monitoring and control of the AMPCS Downlink Process (chill_down)",
                           "API TOS",
