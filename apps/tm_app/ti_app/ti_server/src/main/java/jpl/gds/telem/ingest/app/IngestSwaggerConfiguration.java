...
/**
 * Swagger Auto-Documentation Configuration
 * 
 */
@Configuration
@EnableSwagger2
public class IngestSwaggerConfiguration {
    /**
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("AMPCS Telemetry Ingest with RESTful Monitor & Control",
                           "The Telemetry Ingest RESTful API allows runtime monitoring and control of the AMPCS "
                                   + "Telemetry Ingest Process (chill_telem_ingest)",
                           "API TOS",
