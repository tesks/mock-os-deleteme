...
/**
 * This is an the command argument GUI control class for signed integer
 * command arguments.
 * 
 */
public class IntegerArgumentGuiControl extends
AbstractNumericArgumentGuiControl {
    ...
    public Label createPrefixControl(final Composite parent) {
        ...
        prefix.setText(getDisplayName() + " (I" + getDefinition().getBitLength() + "):");
        return (prefix);
    }
