...
/**
 * This is an the command argument GUI control class for floating point command
 * arguments.
 * 
 ...
 */
public class FloatArgumentGuiControl extends AbstractNumericArgumentGuiControl {
    /**
     * {@inheritDoc}
     * 
    ...
    public Label createPrefixControl(final Composite parent) {
        ...
        prefix.setText(getDisplayName() + " (F" + getDefinition().getBitLength() + "):");
        return (prefix);
    }
}
