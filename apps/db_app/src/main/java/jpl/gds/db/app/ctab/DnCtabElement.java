 ...
 *
 * This class does DN values.
 *
 */
public class DnCtabElement extends ValueCtabElement
{
     ...
     *             Ctab exception
     */
    public DnCtabElement(final List<IDbChannelSampleProvider> channels,
                         final int                        index,
                         final String                     name, 
    ...
    public void appendAsString(final StringBuilder sb) throws CtabException
    {
        ...
        if (this.formatChanVals && value != null && cv.getDnFormat() != null) {
        	sb.append(formatter.anCsprintf(cv.getDnFormat(), value));
        } else {
    ...
    {
        super.appendAsString(sb);
        sb.append(getChannelName()).append("(DN)");
    }
}
