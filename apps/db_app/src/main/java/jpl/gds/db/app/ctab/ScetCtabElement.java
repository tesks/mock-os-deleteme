 ...
 *
 * This class does SCET times.
 *
 */
public class ScetCtabElement extends TimeCtabElement
{
     ...
     */
    public ScetCtabElement(final List<IDbChannelSampleProvider> channels)
    ...
    public void appendAsString(final StringBuilder sb) throws CtabException
    {
        ...
        final IAccurateDateTime scet = getActiveChannelValue().getScet();
        ...
        sb.append(scet.getFormattedScetFast(true));
    }
