 ...
 *
 * This class does ERT times.
 *
 */
public class ErtCtabElement extends TimeCtabElement
{
    /**
     ...
     */
    public ErtCtabElement(final List<IDbChannelSampleProvider> channels)
    ...
    public void appendAsString(final StringBuilder sb) throws CtabException
    {
        ...
        final IAccurateDateTime ert = getActiveChannelValue().getErt();

        sb.append((ert == null) ? NULL : ert.getFormattedErtFast(true));
    }
